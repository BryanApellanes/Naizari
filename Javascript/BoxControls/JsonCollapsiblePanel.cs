...
using KLGates.Helpers.Web;
using System.Web.UI.HtmlControls;
using System.Web.UI;
using System.Web.UI.WebControls;
using KLGates.Helpers;

namespace KLGates.Javascript.BoxControls
{
    [Obsolete("Bryan Apellanes: This class is kinda dumb, not sure what I was thinking.  This kind of functionality is better implemented as a primarily 'client' side control with basic markup provided by the server.")]
