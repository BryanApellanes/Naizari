...
{
    [Serializable]
    public class Base64EncodedRijndaelKeyVectorPair : IKeyVectorPair
    {
        ...
        public static Base64EncodedRijndaelKeyVectorPair Load(string filePath)
        {
            using (StreamReader sr = new StreamReader(filePath))
            {
                ...
                return SerializationUtil.FromXmlString<Base64EncodedRijndaelKeyVectorPair>(xml);
            }
        }
