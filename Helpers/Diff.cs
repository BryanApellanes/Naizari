...
namespace Naizari.Helpers {
  ...
  public class Diff {
    ...
    {
        return DiffCodes(aText, h, trimSpace, ignoreSpace, ignoreCase, '\n');
    }
    ...
    private static int[] DiffCodes(string aText, Hashtable h, bool trimSpace, bool ignoreSpace, bool ignoreCase, params char[] separators) {
